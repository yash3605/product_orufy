  ...
  return (
    <div className="min-h-screen flex bg-[#f8f9fa]">
      ...
      <div className="hidden lg:flex lg:w-[48%] relative p-6">
        ...
        >
          {/* Abstract 3D Wave Background Shapes */}
      ...
      <div className="w-full lg:w-[52%] flex items-center justify-center p-8 lg:p-12">
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-8">
              ...
              <input
                ...
                className="w-full px-4 py-3.5 border border-gray-300 rounded-xl text-[15px] text-gray-800 bg-white focus:border-[#1a1a6c] focus:ring-1 focus:ring-[#1a1a6c] transition-colors"
              />
            </div>
          ...
          {/* Sign Up Link */}
          <div className="mt-8 border border-gray-200 rounded-xl p-5 text-center bg-white">
            <p className="text-gray-500 text-sm">Don't have a Productr Account</p>
            <Link to="/signup" className="text-[#1a1a6c] font-bold text-sm hover:underline inline-block mt-0.5">
              SignUp Here
            </Link>
          </div>
        </div>
