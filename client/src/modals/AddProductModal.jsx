        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-xl text-[15px] text-gray-800 bg-white placeholder-gray-400 focus:border-[#1a1a6c] focus:ring-1 focus:ring-[#1a1a6c] transition-colors ${
          ...
          <div>
            ...
            {imagePreviews.length > 0 ? (
              ...
              <label className="flex flex-col items-center justify-center w-full h-[88px] border border-gray-300 rounded-xl cursor-pointer hover:border-[#1a1a6c] transition-colors">
                <span className="text-sm text-gray-400">Enter Description</span>
                <span className="text-sm text-gray-800 font-semibold">Browse</span>
                <input type="file" accept="image/*" multiple onChange={handleImageChange} className="hidden" />
              </label>
            )}
          </div>
